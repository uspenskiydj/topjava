...
<script type="text/javascript">
    ...
    <c:forEach var="key" items='<%=new String[]{"common.confirm","common.cancel","common.save","common.confirm","common.errorStatus","common.saved","common.deleted","common.select","common.add","meal.filter"}%>'>
